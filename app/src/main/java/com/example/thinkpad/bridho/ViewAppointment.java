...
public class ViewAppointment extends AppCompatActivity {
    ...
    private static final String TAG = "ViewAppointment";
        ...
        appointmentlist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(itemID > -1){
                    ...
                    Intent editScreenIntent = new Intent(ViewAppointment.this, EditAppointment.class);
                    editScreenIntent.putExtra("id",itemID);
                    editScreenIntent.putExtra("name",name);
                    editScreenIntent.putExtra("address",name);
                    editScreenIntent.putExtra("name",name);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        Intent intent = new Intent(ViewAppointment.this, Reminder.class);
