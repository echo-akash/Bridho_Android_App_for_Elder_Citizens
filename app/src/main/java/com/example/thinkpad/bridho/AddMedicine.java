...
public class AddMedicine extends AppCompatActivity {
    ...
    public static AddMedicine inst;

    public static AddMedicine instance() {
        return inst;
    }
    ...
    public void setTime(View view) {
        ...
        timePickerDialog = new TimePickerDialog(
                AddMedicine.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void makeAppointment(Appointment appoint) {
        ...
        if (insertData) {
            ...
            Intent intent = new Intent(AddMedicine.this, Reminder.class);
    ...
    private void setMedRemind(){
        ...
        Intent intent = new Intent(AddMedicine.this,MedicineAlarmReceiver.class);
        toastMessage("1");
 ...
 /*   private void setBootReceiverEnabled(int componentEnabledState){
        ComponentName componentName = new ComponentName(this, MedicineAlarmReceiver.class);
